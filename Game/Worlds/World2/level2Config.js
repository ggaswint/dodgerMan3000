...
export default LevelInit = {
    things: {
        ...
        enemy2: {
            locationX: gameScreenX - (100 + (Constants.MAX_WIDTH * 0.25 / 2) / 2),
            locationY: Constants.MAX_HEIGHT / 2 - 47.5, //Constants.MAX_HEIGHT - 76,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.5,
            // vertices: [
            //     { x: 0, y: 0 },
        ...
        enemy3: {
            locationX: 100 + (Constants.MAX_WIDTH * 0.25 / 2) / 2,
            locationY: Constants.MAX_HEIGHT / 2 - 47.5, //Constants.MAX_HEIGHT - 76,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.5,
            // vertices: [
