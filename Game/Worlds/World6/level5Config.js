...
export default LevelInit = {
    things: {
        ...
        enemy2: {
            locationX: gameScreenX * 0.65,
            locationY: Constants.MAX_HEIGHT * 0.4, //Constants.MAX_HEIGHT - 76,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.7,
            vertices: [
                { x: 0, y: 0 },
        ...
        platform0SideL: {
            locationX: gameScreenX / 2 - 25 - Constants.MAX_WIDTH * 0.01 / 2 + 1,
            locationY: 0 - Constants.MAX_HEIGHT * 0.25 + 25,
        ...
        platform1SideL: {
            locationX: gameScreenX / 2 - 25 - Constants.MAX_WIDTH * 0.01 / 2 + 1,
            locationY: 0 + Constants.MAX_HEIGHT * 0.25 + 25 - 1,
            sizeX: Constants.MAX_WIDTH * 0.01,
            sizeY: Constants.MAX_HEIGHT * 0.5 - 1,
            isInternalStaticBody: false,
            extras: {
