...
export default LevelInit = {
    things: {
        ...
        enemy5: {
            ...
            locationY: Constants.MAX_HEIGHT / 2 + 20, //Constants.MAX_HEIGHT - 76,
            sizeX: 50,
            sizeY: 50 * 0.7,
            vertices: [
                { x: 0, y: 0 },
        ...
        enemy6: {
            locationX: gameScreenX * 0.4,
            locationY: Constants.MAX_HEIGHT * 0.8, //Constants.MAX_HEIGHT - 76,
            sizeX: 50,
            sizeY: 50 * 0.7,
            vertices: [
                { x: 0, y: 0 },
