...
export default LevelInit = {
    things: {
        ...
        enemy2: {
            locationX: gameScreenX * 0.1,
            locationY: Constants.MAX_HEIGHT * 0.2, //Constants.MAX_HEIGHT - 76,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.7,
            vertices: [
                { x: 0, y: 0 },
        ...
        platform4: {
            locationX: Constants.MAX_WIDTH * 0.01 / 2 + Constants.MAX_WIDTH * 0.25 + 60 + Constants.MAX_WIDTH * 0.25 / 2,
