...
export default LevelInit = {
    things: {
        ...
        platform1: {
            locationX: gameScreenX - (Constants.MAX_WIDTH * 0.75 / 2 + 50) + 2.5,
        ...
        platform2: {
            locationX: gameScreenX - (Constants.MAX_WIDTH * 0.5 / 2 + 50) + 2.5,
        ...
        platform3: {
            locationX: gameScreenX - (Constants.MAX_WIDTH * 0.25 / 2 + 50) + 2.5,
            locationY: 0,
