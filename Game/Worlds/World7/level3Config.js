...
export default LevelInit = {
    things: {
        enemy1: {
            ...
            locationY: Constants.MAX_HEIGHT * 0.1, //Constants.MAX_HEIGHT - 76,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.7,
            vertices: [
                { x: 0, y: 0 },
        ...
        enemy2: {
            ...
            locationY: Constants.MAX_HEIGHT / 2 - 27.5,
            sizeX: 50 * 0.7,
            sizeY: 50 * 0.4,
            vertices: [
                { x: 0, y: 0 },
        ...
        platform1: {
            ...
            locationY: Constants.MAX_HEIGHT / 3 + 50,
