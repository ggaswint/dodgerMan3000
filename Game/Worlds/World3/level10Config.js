...
export default LevelInit = {
    things: {
        ...
        platform5: {
            locationX: gameScreenX * 0.25 / 2 + gameScreenX * 0.25 - 2.5 - 50,
            locationY: Constants.MAX_HEIGHT - 50 - Constants.MAX_HEIGHT * 0.5 / 2,
            sizeX: Constants.MAX_WIDTH * 0.2,
            sizeY: 5,
            isInternalStaticBody: false,
            extras: {
                bodyType: "rectangle",
            ...
            entity: {
                ...
                color: 'green',
                renderer: Wall,
                size: [Constants.MAX_WIDTH * 0.2, 5],
            },
        },
        platform6: {
            locationX: gameScreenX * 0.25 / 2 + gameScreenX * 0.5 - 2.5 + 50,
            locationY: Constants.MAX_HEIGHT - 50 - Constants.MAX_HEIGHT * 0.5 / 2,
            sizeX: Constants.MAX_WIDTH * 0.2,
            sizeY: 5,
            isInternalStaticBody: false,
