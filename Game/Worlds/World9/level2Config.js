...
export default LevelInit = {
    things: {
        ...
        platform4: {
            ...
            locationY: Constants.MAX_HEIGHT / 2 - 450,
            sizeX: Constants.MAX_WIDTH * 0.75,
            sizeY: 5,
            isInternalStaticBody: false,
            extras: {
        ...
        platform5: {
            locationX: gameScreenX * 0.3 - (Constants.MAX_WIDTH * 0.25 / 2 + 50),
        ...
        platform5Side: {
            locationX: gameScreenX * 0.3 - (Constants.MAX_WIDTH * 0.25 + 50),
            locationY: Constants.MAX_HEIGHT / 3,
