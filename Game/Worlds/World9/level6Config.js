...
export default LevelInit = {
    things: {
        ...
        platform5: {
            locationX: gameScreenX * 0.5 - (Constants.MAX_WIDTH * 0.25 / 2 + 50),
        ...
        platform5Side: {
            locationX: gameScreenX * 0.5 - (Constants.MAX_WIDTH * 0.25 + 50),
            locationY: Constants.MAX_HEIGHT / 3,
