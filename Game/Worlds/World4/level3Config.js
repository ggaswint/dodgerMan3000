...
export default LevelInit = {
    things: {
        enemy2: {
            locationX: Constants.MAX_WIDTH * 0.5 * 0.25 + 50,
        ...
        platform1: {
            locationX: Constants.MAX_WIDTH * 0.5 / 4 + 50,
        ...
        platform2: {
            locationX: Constants.MAX_WIDTH * 0.5 * 0.75 + 50,
            locationY: Constants.MAX_HEIGHT / 2,
            sizeX: Constants.MAX_WIDTH * 0.25,
            sizeY: 50,
            isInternalStaticBody: true, // Can body prevent bullet fire
        ...
        platform1Side: {
            locationX: Constants.MAX_WIDTH * 0.5 + 50,
            locationY: Constants.MAX_HEIGHT / 2,
        ...
        props: {
            arch: {
                ...
                entity: {
                    body: {
                        position: {
                            x: Constants.MAX_WIDTH * 0.5 / 2,
                            y: Constants.MAX_HEIGHT / 2 - 50,
                        },
                    },
                    size: [50, 50],
                    image: 'world4_stone',
