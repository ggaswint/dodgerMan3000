...
export default LevelInit = {
    things: {
        ...
        platform3: {
            locationX: Constants.MAX_WIDTH * 0.01 / 2 + Constants.MAX_WIDTH * 0.25 + 50 + Constants.MAX_WIDTH * 0.25 / 2 - 5,
            locationY: Constants.MAX_HEIGHT * 0.65,
        ...
        platform4: {
            ...
            locationY: Constants.MAX_HEIGHT * 0.05,
            sizeX: Constants.MAX_WIDTH * 0.25,
            sizeY: 5,
            isInternalStaticBody: false,
            extras: {
