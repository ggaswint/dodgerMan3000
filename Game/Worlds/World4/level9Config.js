...
export default LevelInit = {
    things: {
        ...
        enemy2: {
            locationX: Constants.MAX_WIDTH * 0.8,
        ...
        platform2: {
            locationX: Constants.MAX_WIDTH * 0.7 + 50,
            locationY: Constants.MAX_HEIGHT - 50 - Constants.MAX_WIDTH * 0.2 / 2,
            sizeX: 50,
            sizeY: Constants.MAX_WIDTH * 0.2,
            isInternalStaticBody: true, // Can body prevent bullet fire
        ...
        platform2SideL: {
            locationX: Constants.MAX_WIDTH * 0.7 - 25 - Constants.MAX_WIDTH * 0.01 / 2 + 50,
            locationY: Constants.MAX_HEIGHT - 50 - Constants.MAX_WIDTH * 0.2 / 2,
            sizeX: Constants.MAX_WIDTH * 0.01,
            sizeY: Constants.MAX_WIDTH * 0.2 - 1,
            isInternalStaticBody: false,
        ...
        platform3: {
            locationX: Constants.MAX_WIDTH * 0.5 + Constants.MAX_WIDTH * 0.01 / 2 + 47.5,
            locationY: Constants.MAX_HEIGHT - 50 - Constants.MAX_WIDTH * 0.2 + 2.5,
            sizeX: Constants.MAX_WIDTH * 0.4 - 60,
            sizeY: 5,
            isInternalStaticBody: false,
            extras: {
                bodyType: "rectangle",
            ...
            entity: {
                ...
                color: 'green',
                renderer: Wall,
                size: [Constants.MAX_WIDTH * 0.4 - 60, 5],
            },
        },
    },
    params: {
