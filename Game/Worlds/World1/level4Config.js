...
export default LevelInit = {
    things: {
        ...
        platform1: {
            locationX: Constants.MAX_WIDTH * 0.5,
        ...
        platform1SideR: {
            locationX: Constants.MAX_WIDTH * 0.5 + Constants.MAX_WIDTH * 0.25 / 2,
            locationY: Constants.MAX_HEIGHT / 2,
        ...
        platform2: {
            ...
            locationY: Constants.MAX_HEIGHT / 5 - 30,
            sizeX: Constants.MAX_WIDTH * 0.25,
            sizeY: 50,
            isInternalStaticBody: true, // Can body prevent bullet fire
            extras: {
        ...
        platform3: {
            locationX: Constants.MAX_WIDTH * 0.5 + 50 + (gameScreenX - Constants.MAX_WIDTH * 0.5) / 2,
